        ...
        case "Lập phiếu": {
          ...
          WHERE
              ...
              else
              {
                ...
                echo '<script> window.location="../NHANVIENKHO3/LapPhieuXuatTP.php?idBMX='.$idBMX.'"</script>';
              } 
          }
          else
          {
            ...
            echo '<script> window.location="../NHANVIENKHO3/LapPhieuXuatNVL.php?idBMX='.$idBMX.'"</script>';
          }
          break;
      }
