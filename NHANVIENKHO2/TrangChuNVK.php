   ...
   <div class="containerTC">
    <div class="TCLeft">
        ...
        <div class="TCRight">
            ...
            FROM bieumauxuat 
            WHERE (trangThai = '' OR trangThai IS NULL) AND maKho IN ('KTP01', 'KTP02', 'KTP03')"); ?>">
            ...
            <div class="TCRight-func">
                <a href="PhieuXuatTP.php">Phiếu xuất thành phẩm</a>
            </div>
            <div class="TCRight-func">
                <a href="PhieuNhapTP.php">Phiếu nhập thành phẩm</a>
            </div>
            <div class="TCRight-func">
                <a href="UPPhieuNhapTP.php">Cập nhật phiếu nhập thành phẩm</a>
            </div>
			<div class="TCRight-func">
            ...
            <div class="TCRight-func">
                <a href="PhieuNhapTP.php">Lập biên bản bồi thường TP</a>
            </div>
              <div class="TCRight-func">
