    ...
    <form method="post" enctype="multipart/form-data" name="form1" id="form1">
      ...
      switch ($_POST['button']) {
        case "Lập phiếu": {
            ...
            $lapPhieu = $p->InsertUpdate("INSERT INTO phieuxnvl(maPXNVL,maNVKho,tenNguoiNhan,ngayxuat,ngayLap) 
                VALUES('$maPhieuXNVL','$maNV','$tenNguoiNhan','$ngayxuat','$ngayLap')");
          ...
          WHERE
                ...
                while ($row = mysql_fetch_array($result)) {
                  ...
                  $maNVL =$p->pickColumn("select maNguyenVatLieu from nguyenvatlieu where tenNguyenVatLieu = '$tenSP'");
                      if($p->InsertUpdate("UPDATE nguyenvatlieu SET soLuongTonnvl = $sltMoi WHERE tenNguyenVatLieu = '$tenSP'")== 1)
                      {
                        ...
                        echo '<script> window.location="../NHANVIENKHO2/TrangChuNVK.php" </script>';
                      }
                      else
                      {
              ...
              else
              {
                ...
                echo '<script> window.location="../NHANVIENKHO2/LapPhieuXuatTP.php?idBMX='.$idBMX.'"</script>';
              } 
          }
          else
          {
            ...
            echo '<script> window.location="../NHANVIENKHO2/LapPhieuXuatNVL.php?idBMX='.$idBMX.'"</script>';
          }
          break;
      }
