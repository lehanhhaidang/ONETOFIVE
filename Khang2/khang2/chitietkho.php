...
<body> 
    ...
    <section id="sec"> <br> 
     ...
     <?php
            ...
            $p -> viewchitietkhotren($_REQUEST["makho"]);
        ...
        <div class="thongtindonhang">
            <table class="thongtindonhangtb">
             ...
             if(isset($_REQUEST["makho"]) ){
            $p -> viewchitietkhoduoi($_REQUEST["makho"]);
       ...
       <a href="thongtinkho.php" ><input width="48px" height="48px" class="btn" type="button" value="Quay lại"></a><br>
