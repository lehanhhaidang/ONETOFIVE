...
<body> 
    ...
    <section id="sec">
        <br> <center><h2>ĐIỀU PHỐI XUẤT</h2></center><br>
        ...
        <div class="dieuphoi-right">
              ...
              //  $randomNumber = mt_rand(19, 230);
                $result = 'BMX'.mt_rand(19, 230);
                 if(isset($_REQUEST["maDonHang"]) ){
                    echo ' <br>
                    <h3>Danh sách xuất  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp
                             &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp
                              &nbsp &nbsp &nbsp&nbsp &nbsp Mã Đơn Hàng: '. $_REQUEST["maDonHang"].'
                     ...
                     {
                        echo ' <br>
                        <h3>Danh sách xuất  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp
                                 &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp
                                  &nbsp &nbsp &nbsp&nbsp &nbsp Mã Phiếu:  '. $_REQUEST["maYCXNVL"].'
                                  &nbsp &nbsp&nbsp &nbsp
                                  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp Mã biểu mẫu:  '.$result.'
                                  </h3><br> <br> ';
             ...
             if(isset($_REQUEST["maDonHang"]) ){
            $p -> viewALLDieuPhoiChiTietDonHang($_REQUEST["maDonHang"]);
            
                
             }if(isset($_REQUEST["maYCXNVL"]) ){
                $p -> viewALLDieuPhoiChiTietPhieuYCXNVL($_REQUEST["maYCXNVL"]);
             }
             ...
             if(isset($_REQUEST["btnsubmit"])){
               ...
               // echo"$mabieumau, $makho, $tennguoinhan,$ngayxuat, $loaixuat, $trangthai";   
                    if($ngayxuat < $ngayHienTai){
                        echo"<script> alert('Ngày xuất phải >= ngày hiện tại') </script>";
                    }else{
                        $p = new ControllerSanPham();
                        $kq = $p -> adddieuphoi($result, $makho, $tennguoinhan,$ngayxuat, $loaixuat, $trangthai);
                        
                        if($kq){
                            
                            if(isset($_REQUEST["maDonHang"]) ){
                                $p ->  cupdateAllDonHang($_REQUEST["maDonHang"]);
                                
                                 }if(isset($_REQUEST["maYCXNVL"]) ){
                                    $p -> cupdateAllPhieuYCXNVL($_REQUEST["maYCXNVL"]);
                                 }
                                 echo"<script> alert('Điều phối thành công') </script>";
                                 echo '<script language="javascript">
                                                    window.location="dieuphoixuat.php";
                                                    </script>';
                        }else{
