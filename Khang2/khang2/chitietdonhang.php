...
<body> 
    ...
    <?php
            ...
            $p -> viewchitietdonhangtren($_REQUEST["maDonHang"]);
        ...
        <div class="thongtindonhang">
            ...
            <?php
             ...
             if(isset($_REQUEST["maDonHang"]) ){
            $p -> viewchitietdonhang($_REQUEST["maDonHang"]);
       ...
       <a href="donhang.php" ><input width="48px" height="48px" class="btn" type="button" value="Quay lại"></a><br>
