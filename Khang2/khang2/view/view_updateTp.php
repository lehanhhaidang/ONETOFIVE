                            ...
                            <div class="modal-content">
                                ...
                                <div id="form-them-tp" class="modal-body" style="font-size: 15px;" >
                                                ...
                                                if(mysqli_num_rows($hien)){
                                                    while($row= mysqli_fetch_assoc($hien)){?>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" onblur="return kiemTraNhapLieu()" style="font-size: 15px;" value="<?php echo $row['tenThanhPham'];?>" name="tenthanhpham" id="tenthanhpham"
                                    ...
                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            <a href="index1.php?qldstp" style="width: 25%; margin: 5px;font-size: 20px;"  class="btn btn-danger">Hủy</a>           
