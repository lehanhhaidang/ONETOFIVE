...
<head>
    ...
    <title>Cập nhật phiếu nhập nguyên vật liệu</title>
</head>
<body> 
    <header>
    <?php
    ...
    <?php
	   ...
	   if (isset($_REQUEST['maBBBTNVL']))
			...
			?>
					...
					<input type="hidden" name="tinhTrang" value="<?php echo $p->pickColumn("SELECT tinhTrang FROM bienbanboithuongnvl WHERE maBBBTNVL = '$maBBBTNVL' LIMIT 1"); ?>">
...
<div class="back">
    <a href="ChiTietBBBTNVL.php?maBBBTNVL=<?php echo $maBBBTNVL; ?>" class="btn-reset" style="padding: 14px 30px;background-color:#233d5a ; color: #fff;  font-size: 1.6em">Quay lại</a>
