            ...
            <div class="kho">
                ...
                <div class="container">
                    <div class="left-column">
                        ...
                        <a href="NguyenVatLieu.php"><h2 style="text-align: center ; color: black">Nguyên vật liệu</h2></a>
                    </div>
                    <div class="right-column">
                        <a href="ThanhPham.php"><h2 style="text-align: center; color: black">Thành phẩm</h2></a>
                    </div>
                </div>
            </div>
            <div class="back" >
