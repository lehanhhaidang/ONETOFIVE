...
<?php
   ...
   <main>
    <section>
            <div class="kho">
                <h1 style="text-align: center">LỊCH SỬ NHẬP</h1>
                <div class="container">
                    <div class="left-column">
                        <h2 style="text-align: center">Nhập nguyên vật liệu</h2><br>
                        <?php $p->xuatdspnnvl("select * from phieunnvl"); ?>
                    </div>
                    <div class="right-column">
                        <h2 style="text-align: center">Nhập thành phẩm</h2><br>
                        <?php $p->xuatdspntp("select * from phieuntp"); ?>
                    </div>
                </div>
            </div>
            <div class="back" >
