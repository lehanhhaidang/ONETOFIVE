...
<body> 
    ...
    <section>
        <h1>PHIẾU YÊU CẦU XUẤT NGUYÊN VẬT LIỆU</h1> <br>
        ...
        <div class="btn">
            <input type="reset" value="Từ chối" class="btn-reset">
            <input type="submit" name="btnsubmit" value="Duyệt" class="btn-submit">
        </div>
        </form>
    </section>
   <?php
