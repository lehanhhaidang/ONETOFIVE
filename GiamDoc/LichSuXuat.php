...
<?php
   ...
   <main>
    <section>
            <div class="kho">
                <h1 style="text-align: center">LỊCH SỬ XUẤT</h1>
                <div class="container">
                    <div class="left-column">
                         <h2 style="text-align: center">Xuất nguyên vật liệu</h2>
                        <?php $p->xuatdspxnvl("select * from phieuxnvl"); ?>
                    </div>
                    <div class="right-column">
                        <h2 style="text-align: center">Xuất thành phẩm</h2>
                        <?php $p->xuatdspxtp("select * from phieuxtp"); ?>
                    </div>
                </div>
            </div>
            <div class="back" >
