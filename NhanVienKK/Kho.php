...
<body> 
    ...
    ?>
   <main>
    <h1 style="margin-top: 140px; text-align: center;">DANH SÁCH KHO</h1>
    <div class="kho">
       <?php
				$p->xuatdskhoNVL("select * from kho where makho IN ('KNVL01', 'KNVL02', 'KNVL03', 'KNVL04')");
		
				$p->xuatdskhotp("select * from kho where makho IN ('KTP01', 'KTP02', 'KTP03', 'KTP04', 'KTP05', 'KTP06')");
	
		?>
    </div>
    <div class="back" style="margin-right: 14.5%;">
       <a href="TrangChukk.php"><button>Quay lại</button></a> 
    </div>
   </main>
   <?php
        include("footer.php");
